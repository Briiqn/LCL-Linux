#User Variables
Directory=~/.minecraft
echo -n "Please enter a number for allocated memory: " 
read number 
e=0
allocated=$((e + $number))
echo "The sum of $number and 10 is $allocated."
